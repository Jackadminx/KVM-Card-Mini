...
from Resources.ui import main_ui
...
class MyMainWindow(QMainWindow, main_ui.Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # self.device_setup_dialog = loadUi(
        #     "/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/ui/device_setup_dialog.ui"
        # )
        self.device_setup_dialog = loadUi(
            os.path.join(main_dir, "ui/device_setup_dialog.ui"))
        self.device_setup_dialog.setWindowFlags(Qt.CustomizeWindowHint
                                                | Qt.WindowCloseButtonHint)

        # self.shortcut_key_dialog = loadUi(
        #     "/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/ui/shortcut_key.ui"
        # )
        self.shortcut_key_dialog = loadUi(
            os.path.join(main_dir, "ui/shortcut_key.ui"))
        self.shortcut_key_dialog.setWindowFlags(Qt.CustomizeWindowHint
                                                | Qt.WindowCloseButtonHint)
        applybutton = self.shortcut_key_dialog.buttonBox.button(
        ...
        # with open(
        #         "/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/Data/keyboard_scancode2hid.yml",
        #         'r') as load_f:
        #     self.keyboard_scancode2hid = yaml.safe_load(load_f)
        with open(os.path.join(main_dir, "Data/keyboard_scancode2hid.yml"),
                  'r') as load_f:
            self.keyboard_scancode2hid = yaml.safe_load(load_f)
        # with open(
        #         "/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/Data/keyboard.yaml",
        #         'r') as load_f:
        #     self.keyboard_code = yaml.safe_load(load_f)
        with open(os.path.join(main_dir, "Data/keyboard.yaml"), 'r') as load_f:
            self.keyboard_code = yaml.safe_load(load_f)
        # with open(
        #         "/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/Data/config.yaml",
        #         'r') as load_f:
        #     self.configfile = yaml.safe_load(load_f)
        with open(os.path.join(main_dir, "Data/config.yaml"), 'r') as load_f:
            self.configfile = yaml.safe_load(load_f)
        # 加载配置文件
        ...
        # self.setWindowIcon(
        #     QtGui.QIcon(
        #         '/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/ui/images/24/monitor-multiple.png'
        #     ))
        self.setWindowIcon(
            QtGui.QIcon(
                os.path.join(main_dir, "ui/images/24/monitor-multiple.png")))
        # self.device_setup_dialog.setWindowIcon(
        #     QtGui.QIcon(
        #         '/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/ui/images/24/import.png'
        #     ))
        self.device_setup_dialog.setWindowIcon(
            QtGui.QIcon(os.path.join(main_dir, "ui/images/24/import.png")))
        # self.shortcut_key_dialog.setWindowIcon(
        #     QtGui.QIcon(
        #         '/Users/huangzhewei/Documents/Develop/KVM-Card-Mini/Client/ui/images/24/keyboard-settings-outline.png'
        #     ))
        self.shortcut_key_dialog.setWindowIcon(
            QtGui.QIcon(
                os.path.join(main_dir,
                             "ui/images/24/keyboard-settings-outline.png")))
        ...
        self.statusbar_icon1.setPixmap(
            QPixmap(os.path.join(main_dir, 'ui/images/24/video-off.png')))
        self.statusbar_icon2.setPixmap(
            QPixmap(os.path.join(main_dir, 'ui/images/24/keyboard-off.png')))
        ...
        # 菜单栏图标
        self.action_video_devices.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/import.png')))
        self.action_video_device_connect.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/video.png')))
        self.action_video_device_disconnect.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/video-off.png')))
        self.actionMinimize.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/window-minimize.png')))
        self.actionexit.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/window-close.png')))
        self.actionReload_Key_Mouse.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/reload.png')))
        self.action_fullscreen.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/fullscreen.png')))
        self.action_Resize_window.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/resize.png')))
        self.actionResetKeyboard.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/reload.png')))
        self.actionResetMouse.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/reload.png')))
        self.menuShortcut_key.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/keyboard-outline.png')))
        self.actionCustomKey.setIcon(
            QIcon(
                os.path.join(main_dir,
                             'ui/images/24/keyboard-settings-outline.png')))
        self.actionCapture_mouse.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/mouse.png')))
        self.actionRelease_mouse.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/mouse-off.png')))
        self.actionOn_screen_Keyboard.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/keyboard-variant.png')))
        self.actionCalculator.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/calculator.png')))
        self.actionSnippingTool.setIcon(
            QIcon(os.path.join(main_dir,
                               'ui/images/24/monitor-screenshot.png')))
        self.actionNotepad.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/notebook-edit.png')))
        self.actionIndicator_light.setIcon(
            QIcon(os.path.join(main_dir, 'ui/images/24/led-diode.png')))
        ...
        if self.online_webcams:
            ...
            try:
                self.get_webcam(self.camera_config['device_No'],
        ...
        # 快捷键菜单设置快捷键名称
        self.actionq1.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][0])
        self.actionq2.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][1])
        self.actionq3.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][2])
        self.actionq4.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][3])
        self.actionq5.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][4])
        self.actionq6.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][5])
        self.actionq7.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][6])
        self.actionq_8.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][7])
        self.actionq9.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][8])
        self.actionq10.setText(
            self.configfile['shortcut_key']['shortcut_key_name'][9])

        # 按键绑定
        self.action_video_device_connect.triggered.connect(
            lambda: self.set_webcam(True))
        self.action_video_device_disconnect.triggered.connect(
            lambda: self.set_webcam(False))
        ...
        self.actionReload_Key_Mouse.triggered.connect(
            lambda: self.reset_keymouse(4))
        ...
        self.actionResetKeyboard.triggered.connect(
            lambda: self.reset_keymouse(1))
        ...
        self.actionCalculator.triggered.connect(
            lambda: self.menu_tools_actions(1))
        self.actionSnippingTool.triggered.connect(
            lambda: self.menu_tools_actions(2))
        self.actionNotepad.triggered.connect(
            lambda: self.menu_tools_actions(3))
    ...
    def device_config(self):
        ...
        self.device_setup_dialog.comboBox.setCurrentIndex(
            self.camera_config['device_No'])
        resolution_str = str(self.camera_config['resolution_X']) + 'x' + str(
            self.camera_config['resolution_Y'])
        ...
        if info == 1:
            ...
            self.camera_config[
                'device_No'] = self.device_setup_dialog.comboBox.currentIndex(
                )
            self.camera_config['resolution_X'] = int(
                self.device_setup_dialog.comboBox_2.currentText().split(
                    'x')[0])
    ...
    def update_device_setup_resolutions(self):
        ...
        camera_info = QCamera(QCameraInfo.availableCameras()[
    ...
    def resize_window_func(self):
        self.resize(self.camera_config['resolution_X'],
                    self.camera_config['resolution_Y'] + 60)
    ...
    def shortcut_key_func(self, s):
        ...
        wm_size = self.size()
        self.shortcut_key_dialog.move(wm_pos.x() + (wm_size.width() - 542),
                                      wm_pos.y() + (wm_size.height() - 330))
    ...
    def shortcut_key_handle(self, s):
        ...
        if s == 0xff:  # keySequenceChanged
            if self.shortcut_key_dialog.keySequenceEdit.keySequence().count(
            ) == 0:  # 去除多个复合键
                keysequence = ""
                return
            elif self.shortcut_key_dialog.keySequenceEdit.keySequence().count(
            ) == 1:
                keysequence = self.shortcut_key_dialog.keySequenceEdit.keySequence(
                ).toString()
            else:
                keysequence = self.shortcut_key_dialog.keySequenceEdit.keySequence(
                ).toString().split(",")
            ...
            if len(re.findall("\+", keysequence)) == 0:  # 没有匹配到+号，不是组合键
                ...
                if keysequence != '+':
                    ...
                    if [s for s in keysequence_list if "Ctrl" in s]:
                        self.shortcut_key_dialog.pushButton_ctrl.setChecked(
                            True)
                        buffer[2] = buffer[2] | 1
                    else:
                        self.shortcut_key_dialog.pushButton_ctrl.setChecked(
                    ...
                    if [s for s in keysequence_list if "Alt" in s]:
                        self.shortcut_key_dialog.pushButton_alt.setChecked(
                            True)
                        buffer[2] = buffer[2] | 4
                    else:
                        self.shortcut_key_dialog.pushButton_alt.setChecked(
                    ...
                    if [s for s in keysequence_list if "Shift" in s]:
                        self.shortcut_key_dialog.pushButton_shift.setChecked(
                            True)
                        buffer[2] = buffer[2] | 2
                    else:
                        self.shortcut_key_dialog.pushButton_shift.setChecked(
    ...
    def shortcut_key_action(self, s):
        if -1 < s < 10:
            hid_def.hid_report(
                self.configfile['shortcut_key']['shortcut_key_hidcode'][s])
            time.sleep(0.1)
    ...
    def device_event_handle(self, s):
        if s == "hid_error":
            self.statusBar().showMessage(
                "Keyboard Mouse connect error, try to <Reload Key/Mouse>")
            self.statusbar_icon2.setPixmap(
                QPixmap(os.path.join(main_dir,
                                     'ui/images/24/keyboard-off.png')))
            ...
            self.statusbar_icon2.setPixmap(
                QPixmap(os.path.join(main_dir,
                                     'ui/images/24/keyboard-off.png')))
            self.statusbar_icon2.setToolTip(
                'Keyboard Mouse initialization error')

        if s == "hid_init_ok":
            self.statusBar().showMessage("Keyboard Mouse initialization done")
            self.statusbar_icon2.setPixmap(
                QPixmap(os.path.join(main_dir, 'ui/images/24/keyboard.png')))
            self.statusbar_icon2.setToolTip(
                'Keyboard Mouse initialization done')
        elif s == "hid_ok":
            self.statusbar_icon2.setPixmap(
                QPixmap('ui/images/24/keyboard.png'))
            self.statusBar().addPermanentWidget(self.statusbar_icon2)
    ...
    def changeEvent(self, event):
        try:  # 窗口未初始化完成时会触发一次事件
            ...
            ) and self.status['init_ok']:  # 窗口失去焦点时重置键盘，防止卡键
    ...
    def mouseMoveEvent(self, event):
        ...
        y_hid = int((32767 * (y - self.camerafinder.pos().y())) /
                    self.camerafinder.height())
    ...
    def keyPressEvent(self, event):
        ...
        scancode2hid = self.keyboard_scancode2hid.get(key, 0)
        # print('scancode2hid', scancode2hid)
        if scancode2hid != 0:
